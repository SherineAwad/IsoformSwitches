...
summary(salmonQuant)
     ...
     condition = c("RNAb","RNAb","RNAb","RNAb","RNAb","WT", "WT","WT") ) 

myDesign


conditions <- data.frame(condition_1 = "WT", condition_2="RNAb")
...
write.csv(myIsoforms, "myisoforms_usage.csv")
...
subset(
    ...
    )[,c('gene_name','condition_2','condition_1','gene_switch_q_value','Rank')],
    gene_name == 'AMER3'
)
